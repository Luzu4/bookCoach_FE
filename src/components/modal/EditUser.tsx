...
import {useGetAllGamesQuery,useUpdateUserGamesMutation} from "../../store/bookCoachApi";
                ...
                <Box sx={boxContainerStyle}>
                    <Grid container spacing={2}
                        ...
                        <Stack direction="column" spacing={2}>
                            <SelectDropDownEnum handleChange={handleChangeRole} roles={Object.keys(Role)} id={role}
                                                initialValue={userRole}/>

                            <MultiSelectDropDownGames availableGames={availableGames} setGames={setGames}
                                                      userGames={userGames.map(game => game.name)}/>
                        </Stack>
